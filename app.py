...
def build_financials_page(symbol, info, holders, fin_tables):
    ...
    return html.Div([
        top,
        html.Div(style={"height": "16px"}),
        html.Div([profile, links], style={"display": "grid", "gridTemplateColumns": "1fr 1fr", "gap": "16px"}),
        html.Div(style={"height": "16px"}),
        holders_card,
        html.Div(style={"height": "16px"}),
        financial_tables
...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            html.Div("Cleaner watchlist, stronger visibility, quick stock intelligence, chart lab, financials and live news in one screen.", style={"color": THEME["muted"], "maxWidth": "900px", "lineHeight": "1.7"})
        ]),
        ...
        html.Div([
            style_card([
                ...
                dcc.Dropdown(
                    ...
                    value=DEFAULT_SYMBOL if DEFAULT_SYMBOL in [o["value"] for o in DROPDOWN_OPTIONS] else None,
